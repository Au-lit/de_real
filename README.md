# de_real (Hen no Rajio-tō : 変のラジオ塔) [WIP]
...
If you want to apply modification you can either apply a serial patch or fork the repo. **Do not** commit changes in master (because you can't). Note that a lot of things are wrote in french.
